...
(Taking ◂ Ctx2 ➔ Raws ➔ ★)
(envTaking ◂ Π GD : Ctx2. Π e : Env GD. Taking GD (elimId ts2rs e))
\end{verbatim}

\caption{\texttt{Lookup}, \texttt{Typed}, and \texttt{Taking} premises and lemmas for relational data enrichment.}
\labfig{inv}
\end{figure}
