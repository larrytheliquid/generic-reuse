...
be computed by as a total function (via the refinement algebra) from
the non-indexed type. When enriching a \verb;Raw; term to a
...
generalized data enrichment \verb;fix2ifixP;:
...
from non-indexed to indexed data.
