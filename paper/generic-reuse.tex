...
making the precondition state that type inference succeeds. In our
...
\caption{An abstract well-typedness relation,\texttt{Typed}, specified
...
defined in terms of a more genercal version that does not perform any
