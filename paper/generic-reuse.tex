...
type is isomorphic to the \verb;Id; typed introduced by
...
is similar to how the \verb;Coercible; type class is
used in Haskell, and the relationship between them is further
